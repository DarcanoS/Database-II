...
\subsubsection*{User Stories Refinement}

Furthermore, the user stories from Workshop~2 were rewritten using a standard template that includes the \emph{As a / I want to / so that} structure, priority, effort estimates, and explicit acceptance criteria. The new set of stories is aligned with the refined functional and non-functional requirements, and focuses on the realistic baseline scope of the project (data ingestion, dashboards, reports, alerts, recommendations and responsive web access), while advanced features such as multi-region deployment and complex map-based navigation are treated as future work rather than baseline commitments. Each of the 14 user stories now appears in a dedicated table with clear role identification, measurable acceptance criteria, and priority classification (Must, Should, Could) that matches the requirement categories. This restructuring addresses the instructor's feedback by eliminating ambiguity about feature scope, providing a clear roadmap for incremental development, and ensuring full traceability between user needs, functional requirements, and system design.
