...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{Imagenes/ER_Geospatial.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{Imagenes/ER_Users_Access.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{Imagenes/ER_Alerts_Recommendations.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{Imagenes/ER_Reporting_Analytics.png}
